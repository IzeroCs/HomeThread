...
| `components/entity/serialization/entity_serialization.c` | ⚠️ Partial | entity_serialize_info_cbor, entity_serialize_entities_cbor, entity_serialize_topology_cbor, entity_serialize_state_cbor; logic Info/Topology inline trong từng hàm; light+sensor encode keys 0–13 (restore_mode); switch/fan/climate/binary_sensor chưa |
