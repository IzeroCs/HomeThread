 ...
 *
 * Hiện tại: CDC = log, UART = frame (FRAME_PORT_IS_UART = 1).
 */

#ifndef COMMUNICATE_CONFIG_H
#define COMMUNICATE_CONFIG_H

/** 1 = frame truyền trên UART, log trên CDC; 0 = frame trên CDC, log trên UART (sau này). */
#define COMMUNICATE_FRAME_PORT_IS_UART  1
