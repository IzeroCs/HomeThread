  ...
  render() {
    ...
    return html`
      <div class="status-page">
        ...
        <p class="status-page-subtitle">Network health and configuration overview</p>

        <section class="status-section status-section-br">
          ${isConnected
            ? html`
                <div class="status-card status-card-br">
                  <div class="status-card-br-icon">
                  ...
                  <div class="status-card-br-content">
                    ...
                    <div class="status-card-br-fields">
                      ...
                      <div class="status-field">
                        ...
                        <span class="status-field-value">—</span>
                      </div>
                    </div>
                    <button
                      type="button"
                      class="status-btn-refresh"
                      @click=${() =>
                        this.brConfig && this.testBrConnect({ brHost: this.brConfig.brHost, brPort: this.brConfig.brPort })}
                    >
            ...
            : html`
                <div class="status-card status-card-br">
                  <div class="status-card-br-icon status-card-br-icon--disconnected">
                  ...
                  <div class="status-card-br-content">
                    <div class="status-card-br-heading">
                      ...
                      <span class="status-badge status-badge--disconnected">
                        <span class="status-badge-dot status-badge-dot--red"></span>
                        Disconnected
                      </span>
                    </div>
                    <div class="status-card-br-fields">
                      <div class="status-field">
                        <span class="status-field-label">Host Address</span>
                        <span class="status-field-value mono-text status-field-value--muted">---</span>
                      </div>
                      <div class="status-field">
                        <span class="status-field-label">Uptime</span>
                        <span class="status-field-value status-field-value--muted">N/A</span>
                      </div>
                    </div>
                    <button
                      type="button"
