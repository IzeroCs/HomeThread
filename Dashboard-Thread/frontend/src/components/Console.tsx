    ...
    <div className="form-page">
      <div className="form-card console-card">
        ...
        <p className="form-page-description">
          Giao tiếp qua frame protocol (TCP). Dữ liệu từ BR hiển thị bên dưới. Cần kết nối BR trước.
        </p>

        {!isConnected && (
          <div className="form-page-alert form-page-alert-warn">
            Chưa kết nối BR. Vào Settings → BR Connection rồi kết nối.
          </div>
        )}
        ...
        <div className="console-log" role="log" aria-live="polite">
          {log.length === 0 && (
            <div className="console-log-placeholder">
              Dữ liệu frame từ BR sẽ hiển thị ở đây khi đã kết nối.
            </div>
          )}
          {log.map((entry, i) => (
