...
import "./br-connection-form.style.scss";
...
export default function BrConnectionForm({ isConnected, onTestConnect }: BrConnectionFormProps) {
  ...
  const handleTestConnect = async () => {
    ...
    if (result.success) {
      ...
      setTestMessage("OTBR available via REST");
    ...
    <div className="form-page">
      <div className="form-page-header">
        ...
        <p className="form-page-description">
          Border Router: OTBR (REST). Backend giao tiếp với otbr-agent qua REST API (port 8081).
        </p>
      </div>
