...
import { wsConnectionActions } from "@/shared/store/slices/ws-connection.slice";
import { configActions } from "@/shared/store/slices/config.slice";
import { brActions } from "@/shared/store/slices/br.slice";
import { otActions } from "@/shared/store/slices/ot.slice";
import { tablesActions } from "@/shared/store/slices/tables.slice";
import { systemActions, type SystemInfo } from "@/shared/store/slices/system.slice";
